...
export default {
  ...
  head() {
    return {
      ...
      meta: [
        { charset: "utf-8" },
        { hid: "description", name: "description", content: "文档续费" },
        { hid: "keyword", name: "keyword", content: "文档续费" },
      ],
    };
  },
  watch: {
    ...
    getTeamInfo() {
      ...
      getTeamMoney({ teamId: teamId }, this).then((res) => {
        if (res.data.code === 1) {
          ...
          this.date = moment(res.data.content.team.endTime).format(
            "YYYY-MM-DD HH:mm:ss"
          );
