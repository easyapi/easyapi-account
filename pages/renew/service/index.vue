  ...
  <div>
    <div class='w-full h-auto'>
      <div class='w-full h-20 bg-gray-50'>
        <span class='m-auto max-w-screen-lg text-lg block'>{{ service.name }}服务续费</span>
      </div>
      <div class='renew_content max-w-screen-lg'>
        ...
        <div class='renew_btn'>
          <el-button type="primary" v-if="balance >= price || payment !== '余额支付'" @click='buy'>
            确定购买
          </el-button>
          <el-button type="primary" v-if="balance < price && payment === '余额支付'" disabled>
            确定购买
          </el-button>
