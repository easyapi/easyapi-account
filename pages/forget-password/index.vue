  ...
  <div id="app">
    <div class="main">
      <div class="form">
        ...
        <el-form ref="ruleForm" :model="data.ruleForm" :rules="rules">
          <el-form-item label="" prop="username">
            <el-input v-model="ruleForm.username" placeholder="请输入手机号码" maxlength="11">
          ...
          <el-form-item label="" prop="code">
            ...
            <el-button :disabled="data.sendCodeBtn" class="getCode" @click="sendCode">
              {{ sendCodeCount }}
            </el-button>
          </el-form-item>
          <el-form-item label="" prop="password">
            <el-input v-model="data.ruleForm.password" placeholder="请输入新密码" type="password" />
          </el-form-item>
          <el-form-item label="" prop="confirmPassword">
            <el-input v-model="data.ruleForm.confirmPassword" placeholder="请再输入一次密码" type="password" />
          </el-form-item>
          <el-button style="width: 100%" type="primary" :disabled="data.disabled" @click="forgetPassword">
            确定
          </el-button>
        </el-form>
        <div class="other-box">
