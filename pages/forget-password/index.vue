  ...
  <div id="app">
    <div class="main">
      <div class="form">
        ...
        <el-form :model="data.ruleForm" :rules="rules" ref="ruleForm">
          <el-form-item label="" prop="username">
            <el-input placeholder="请输入手机号码" maxlength="11" v-model="ruleForm.username">
              <template slot="prepend">+&nbsp;</template>
              <el-select v-model="data.ruleForm.areaCode" filterable allow-create slot="prepend" style="width: 80px">
          ...
          <el-form-item label="" prop="code">
            ...
            <el-button :disabled="data.sendCodeBtn" class="getCode" @click="sendCode">{{ sendCodeCount }}</el-button>
          </el-form-item>
          <el-form-item label="" prop="password">
            <el-input placeholder="请输入新密码" type="password" v-model="data.ruleForm.password"></el-input>
          </el-form-item>
          <el-form-item label="" prop="confirmPassword">
            <el-input placeholder="请再输入一次密码" type="password" v-model="data.ruleForm.confirmPassword"></el-input>
          </el-form-item>
          <el-button style="width: 100%" type="primary" :disabled="data.disabled" @click="forgetPassword">确定</el-button>
        </el-form>
        <div class="other-box">
