		...
		<div class="form">
			...
			<el-form :model="data.ruleForm" :rules="data.rules" ref="ruleForm">
				...
				<el-form-item label="" prop="password">
					<el-input v-model="data.ruleForm.password" type="password" placeholder="请输入密码"></el-input>
				</el-form-item>
				<el-checkbox class="checkbox" v-model="data.ruleForm.rememberMe" checked>记住密码</el-checkbox>
